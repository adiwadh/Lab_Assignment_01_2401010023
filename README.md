...
A simple Java console-based application designed to manage student records.
This project demonstrates **Object-Oriented Programming**, **methods**, **constructors**, **arrays/ArrayList**, and **control structures**, as required in the assignment.
